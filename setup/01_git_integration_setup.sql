...
CREATE OR REPLACE SECRET HELLO_WORLD_DB.DEMO_SCHEMA.GITHUB_PAT
  TYPE = GENERIC_STRING
...
CREATE OR REPLACE API INTEGRATION GITHUB_API_INTEGRATION
  ...
  ALLOWED_AUTHENTICATION_SECRETS = (HELLO_WORLD_DB.DEMO_SCHEMA.GITHUB_PAT)
  ENABLED = TRUE;

-- Step 3: Create the Git Repository object
CREATE OR REPLACE GIT REPOSITORY HELLO_WORLD_DB.DEMO_SCHEMA.CICD_REPO
  ORIGIN = 'https://github.com/sfc-gh-sajain/test_cicd_demo.git'
  API_INTEGRATION = GITHUB_API_INTEGRATION
  GIT_CREDENTIALS = HELLO_WORLD_DB.DEMO_SCHEMA.GITHUB_PAT;
